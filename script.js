...
function applyCtaUrl() {
  const DESTINATION_URL = 'https://googleffkmf.com?ch=8181&fbPixelId=1215309980270625';
...
async function testFacebookConnectivity() {
  ...
  const pixelId = '1215309980270625';
  const testResults = {};
...
async function diagnoseMetaPixel() {
  ...
  testPixel.src = 'https://www.facebook.com/tr?id=1215309980270625&ev=PageView&noscript=1&test=1';
